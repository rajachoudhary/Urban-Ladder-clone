  ...
  return (
    <div className={styles.features}>
      <div>
        ...
        <div className={styles.title}>CARE</div>
        <div className={styles.title}>WARRANTY</div>
        <div className={styles.title}>RETURNS</div>
        <div className={styles.title}>QUALITY</div>
      </div>
      <div>
        <ul>
          <li>
            More the merrier. Throwing a party or hosting extended family?
            Caribu magically expands to accommodate eight guests. With its
            modern aesthetics and sleek finish, this dining table is a delight
