...
export const ProductCard = ({item}) => {
 ...
 <div className={styles.prod_card} onMouseLeave={()=>setShow(false)}  onMouseEnter={()=>setShow(true)}>
 {show ? (<button className={styles.heart_btn}><AiOutlineHeart></AiOutlineHeart> Add To Wishlist</button>) : (<AiOutlineHeart className={styles.heart} ></AiOutlineHeart>)}
    ...
    <div className={styles.btn_div}>
        ...
        <button className={styles.view4option_btn}>VIEW 2 OPTIONS</button>
    </div>
